...
B_fuzzyPIDController_T fuzzyPIDController_B;

/* Block states (auto storage) */
DW_fuzzyPIDController_T fuzzyPIDController_DW;

/* External inputs (root inport signals with auto storage) */
ExtU_fuzzyPIDController_T fuzzyPIDController_U;

/* External outputs (root outports fed by signals with auto storage) */
ExtY_fuzzyPIDController_T fuzzyPIDController_Y;

/* Real-time model */
RT_MODEL_fuzzyPIDController_T fuzzyPIDController_M_;
RT_MODEL_fuzzyPIDController_T *const fuzzyPIDController_M =
  &fuzzyPIDController_M_;

/* Model step function */
void fuzzyPIDController_step(void)
{
  real_T rtb_Product1;
  real_T rtb_Diff_g;
  real_T rtb_TSamp;
   ...
   *  Inport: '<Root>/In4'
   */
  rtb_Product1 = fuzzyPIDController_U.In4 * fuzzyPIDController_U.In1;
   ...
   */
  rtb_TSamp = fuzzyPIDController_U.In1 * fuzzyPIDController_P.TSamp_WtEt;

  /* Sum: '<S2>/Diff' incorporates:
   *  UnitDelay: '<S2>/UD'
   */
  rtb_Diff = rtb_TSamp - fuzzyPIDController_DW.UD_DSTATE;
   ...
   */
  fuzzyPIDController_B.TmpSignalConversionAtAnimation1[0] =
    fuzzyPIDController_U.In5 * fuzzyPIDController_U.In1;
  fuzzyPIDController_B.TmpSignalConversionAtAnimation1[1] =
    fuzzyPIDController_U.In6 * rtb_Diff;

  /* S-Function Block: <S4>/FIS S-function (sffis) */
  {
    FIS *fis = (FIS *)fuzzyPIDController_DW.FISSfunction_PWORK.FISPointer;
    fis->input[0]->value = fuzzyPIDController_B.TmpSignalConversionAtAnimation1
      [0];
    fis->input[1]->value = fuzzyPIDController_B.TmpSignalConversionAtAnimation1
      [1];
    fisEvaluate(fis, 101);
    fuzzyPIDController_B.FISSfunction[0] = fis->output[0]->value;
    fuzzyPIDController_B.FISSfunction[1] = fis->output[1]->value;
    fuzzyPIDController_B.FISSfunction[2] = fis->output[2]->value;
  }
   ...
   */
  rtb_Product = fuzzyPIDController_P.Gain2_Gain *
    fuzzyPIDController_B.FISSfunction[0] * fuzzyPIDController_U.fkp *
    rtb_Product1;
   ...
   */
  rtb_Product1 = fuzzyPIDController_P.Gain3_Gain *
    fuzzyPIDController_B.FISSfunction[1] * fuzzyPIDController_U.fki *
    fuzzyPIDController_DW.DiscreteTimeIntegrator_DSTATE;
   ...
   *  y = u * K where K = 1 / ( w * Ts )
   */
  rtb_TSamp_g = fuzzyPIDController_U.In3 * fuzzyPIDController_U.In1 *
    fuzzyPIDController_P.TSamp_WtEt_h;

  /* Sum: '<S1>/Diff' incorporates:
   *  UnitDelay: '<S1>/UD'
   */
  rtb_Diff_g = rtb_TSamp_g - fuzzyPIDController_DW.UD_DSTATE_f;
   ...
   */
  rtb_Product2 = fuzzyPIDController_P.Gain4_Gain *
    fuzzyPIDController_B.FISSfunction[2] * fuzzyPIDController_U.fkd * rtb_Diff_g;
   ...
   *  Sum: '<Root>/Add3'
   */
  fuzzyPIDController_Y.Out1 =
    ((fuzzyPIDController_DW.DiscreteTimeIntegrator_DSTATE + rtb_Product1) +
     rtb_Add) + (rtb_Diff_g + rtb_Product2);

  /* Outport: '<Root>/dx' */
  fuzzyPIDController_Y.dx = rtb_Diff;

  /* Outport: '<Root>/fuzzy_kp' */
  fuzzyPIDController_Y.fuzzy_kp = rtb_Product;

  /* Outport: '<Root>/fuzzy_ki' */
  fuzzyPIDController_Y.fuzzy_ki = rtb_Product1;

  /* Outport: '<Root>/fuzzy_kd' */
  fuzzyPIDController_Y.fuzzy_kd = rtb_Product2;

  /* Update for UnitDelay: '<S2>/UD' */
  fuzzyPIDController_DW.UD_DSTATE = rtb_TSamp;
   ...
   */
  fuzzyPIDController_DW.DiscreteTimeIntegrator_DSTATE +=
    fuzzyPIDController_U.In2 * fuzzyPIDController_U.In1 *
    fuzzyPIDController_P.DiscreteTimeIntegrator_gainval;

  /* Update for UnitDelay: '<S1>/UD' */
  fuzzyPIDController_DW.UD_DSTATE_f = rtb_TSamp_g;

  /* Matfile logging */
  rt_UpdateTXYLogVars(fuzzyPIDController_M->rtwLogInfo,
                      (&fuzzyPIDController_M->Timing.taskTime0));

  /* signal main to stop simulation */
  {                                    /* Sample time: [2.0s, 0.0s] */
    if ((rtmGetTFinal(fuzzyPIDController_M)!=-1) &&
        !((rtmGetTFinal(fuzzyPIDController_M)-
           fuzzyPIDController_M->Timing.taskTime0) >
          fuzzyPIDController_M->Timing.taskTime0 * (DBL_EPSILON))) {
      rtmSetErrorStatus(fuzzyPIDController_M, "Simulation finished");
    }
  }
   ...
   */
  if (!(++fuzzyPIDController_M->Timing.clockTick0)) {
    ++fuzzyPIDController_M->Timing.clockTickH0;
  }

  fuzzyPIDController_M->Timing.taskTime0 =
    fuzzyPIDController_M->Timing.clockTick0 *
    fuzzyPIDController_M->Timing.stepSize0 +
    fuzzyPIDController_M->Timing.clockTickH0 *
    fuzzyPIDController_M->Timing.stepSize0 * 4294967296.0;
}

/* Model initialize function */
void fuzzyPIDController_initialize(void)
{
  /* Registration code */
  ...
  (void) memset((void *)fuzzyPIDController_M, 0,
                sizeof(RT_MODEL_fuzzyPIDController_T));
  rtmSetTFinal(fuzzyPIDController_M, -1);
  fuzzyPIDController_M->Timing.stepSize0 = 2.0;

  /* Setup for data logging */
  {
    static RTWLogInfo rt_DataLoggingInfo;
    fuzzyPIDController_M->rtwLogInfo = &rt_DataLoggingInfo;
  }

  /* Setup for data logging */
  {
    rtliSetLogXSignalInfo(fuzzyPIDController_M->rtwLogInfo, (NULL));
    rtliSetLogXSignalPtrs(fuzzyPIDController_M->rtwLogInfo, (NULL));
    rtliSetLogT(fuzzyPIDController_M->rtwLogInfo, "tout");
    rtliSetLogX(fuzzyPIDController_M->rtwLogInfo, "");
    rtliSetLogXFinal(fuzzyPIDController_M->rtwLogInfo, "");
    rtliSetLogVarNameModifier(fuzzyPIDController_M->rtwLogInfo, "rt_");
    rtliSetLogFormat(fuzzyPIDController_M->rtwLogInfo, 0);
    rtliSetLogMaxRows(fuzzyPIDController_M->rtwLogInfo, 1000);
    rtliSetLogDecimation(fuzzyPIDController_M->rtwLogInfo, 1);
     ...
     */
    {
      static void * rt_LoggedOutputSignalPtrs[] = {
        &fuzzyPIDController_Y.Out1,
        &fuzzyPIDController_Y.dx,
        &fuzzyPIDController_Y.fuzzy_kp,
        &fuzzyPIDController_Y.fuzzy_ki,
        &fuzzyPIDController_Y.fuzzy_kd
      };

      rtliSetLogYSignalPtrs(fuzzyPIDController_M->rtwLogInfo,
...

    {
      ...
      static const char_T *rt_LoggedOutputBlockNames[] = {
        "fuzzyPIDController/Out1",
        "fuzzyPIDController/dx",
        "fuzzyPIDController/fuzzy_kp",
        "fuzzyPIDController/fuzzy_ki",
        "fuzzyPIDController/fuzzy_kd" };
      ...
      rtliSetLogYSignalInfo(fuzzyPIDController_M->rtwLogInfo,
    ...
    rtliSetLogY(fuzzyPIDController_M->rtwLogInfo, "yout");
  }

  /* block I/O */
  (void) memset(((void *) &fuzzyPIDController_B), 0,
                sizeof(B_fuzzyPIDController_T));

  /* states (dwork) */
  (void) memset((void *)&fuzzyPIDController_DW, 0,
                sizeof(DW_fuzzyPIDController_T));

  /* external inputs */
  (void) memset((void *)&fuzzyPIDController_U, 0,
                sizeof(ExtU_fuzzyPIDController_T));

  /* external outputs */
  (void) memset((void *)&fuzzyPIDController_Y, 0,
                sizeof(ExtY_fuzzyPIDController_T));

  /* Matfile logging */
  rt_StartDataLoggingWithStartTime(fuzzyPIDController_M->rtwLogInfo, 0.0,
    rtmGetTFinal(fuzzyPIDController_M), fuzzyPIDController_M->Timing.stepSize0,
    (&rtmGetErrorStatus(fuzzyPIDController_M)));

  /* S-Function Block: <S4>/FIS S-function (sffis) */
  {
    FIS *fis;
    if ((fis = (FIS *)calloc(1, sizeof(FIS))) == NULL ) {
      rtmSetErrorStatus(fuzzyPIDController_M, "Memory Allocation Error");
      return;
    }
    ...
    fis->next = NULL;
    fuzzyPIDController_DW.FISSfunction_PWORK.FISPointer = fis;
  }

  /* InitializeConditions for UnitDelay: '<S2>/UD' */
  fuzzyPIDController_DW.UD_DSTATE =
    fuzzyPIDController_P.DiscreteDerivative1_ICPrevScale;

  /* InitializeConditions for DiscreteIntegrator: '<Root>/Discrete-Time Integrator' */
  fuzzyPIDController_DW.DiscreteTimeIntegrator_DSTATE =
    fuzzyPIDController_P.DiscreteTimeIntegrator_IC;

  /* InitializeConditions for UnitDelay: '<S1>/UD' */
  fuzzyPIDController_DW.UD_DSTATE_f =
    fuzzyPIDController_P.DiscreteDerivative_ICPrevScaled;
}

/* Model terminate function */
void fuzzyPIDController_terminate(void)
{
  /* S-Function Block: <S4>/FIS S-function (sffis) */
  {
    FIS *fis = (FIS *)fuzzyPIDController_DW.FISSfunction_PWORK.FISPointer;
